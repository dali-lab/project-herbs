...
We'll have to use some Terminal command line dark magic here.  Copy/paste is your friend.  
  ...
  <br>![](docs/img/square.png) 2.2)  ```git clone https://github.com/dali-lab/project-herbs.git```
  <br>![](docs/img/square.png) 2.3)  ```cd project-herbs```
...
Now you can go to [http://dali-lab.github.io/project-herbs](http://dali-lab.github.io/project-herbs) to see your site!
